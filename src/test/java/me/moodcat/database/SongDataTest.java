...
public class SongDataTest {
    ...
    public void persistSongWithData() throws IOException {
        ...
        try(InputStream in = SongDataTest.class.getResourceAsStream("/acousticbrainz/testData/32098913.json")) {
            AcousticBrainzData features = objectMapper.readValue(in, AcousticBrainzData.class);
