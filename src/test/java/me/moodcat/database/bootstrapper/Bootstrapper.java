...
public class Bootstrapper {
    ...
    public void parseFromResource(final String path) throws IOException {
        try(InputStream in = Bootstrapper.class.getResourceAsStream(path)) {
            BEnvironment environment = objectMapper.readValue(in, BEnvironment.class);
    ...
    protected static ChatMessage createChatMessage(BMessage bMessage, Room room) {
    ...
    protected static Song createSong(BSong bSong, Artist artist) {
        Song song = new Song();
